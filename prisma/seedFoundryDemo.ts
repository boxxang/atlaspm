 ...
 *
 * Re-running replaces AtlasFX1 and the template, and nothing else. It refuses
 * if another programme has been started on the template, or if a template of
 * the same name exists under a different id.
 */
